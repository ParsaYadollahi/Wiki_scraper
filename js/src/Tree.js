            ...
            trigger={
                <div>
                    <p className="show_content" style={{ borderLeft: '4px solid #2BDE3F' }}>
                        ...
                        <h3 style={{marginTop : '0px', marginLeft : '40px' }}>URL</h3>
        ...
        return (
            ...
            >
                {({ zoomIn, zoomOut, resetTransform, ...rest }) => (
                    <React.Fragment>
                        <div className="tools">
                            <button className="zoom" onClick={zoomIn}> <Icon size={12} icon={zoom_in}/></button>
                            <button className="zoom" onClick={zoomOut}> <Icon size={12} icon={zoom_out}/></button>
                        </div>
                        <TransformComponent>
